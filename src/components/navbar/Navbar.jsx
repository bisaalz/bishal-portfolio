          ...
          <div className="bg-[#F0F6FD] z-40 2xl:h-[68px] h-[68px] boxShadow sticky top-0 text-white">
            <div className="container">
              <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                >
                  <span className="font-extrabold text-transparent text-3xl bg-clip-text bg-gradient-to-r from-[#ffffff] to-[#ffffff]">
                ...
                <div className="flex md:order-2">
                  <svg
                    ...
                    className="h-6 w-6 mt-2 md:mt-0"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                ...
                >
                  <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 dark:border-gray-700">
                    <li>
                      <a
                        href="#"
                        className="block py-2 pl-3 pr-4 text-white  rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#F55F29] md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                      >
                        HOME
                      </a>
                    </li>
